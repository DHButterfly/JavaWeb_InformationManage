...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="login/themes/default/easyui.css">
    <link rel="stylesheet" type="text/css" href="login/themes/icon.css">
    <link rel="stylesheet" type="text/css" href="login/css/demo.css">
    <script type="text/javascript" src="login/js/jquery.min.js"></script>
    <script type="text/javascript" src="login/js/jquery.easyui.min.js"></script>
</head>
<body>
